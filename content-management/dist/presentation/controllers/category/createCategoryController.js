...
const createCategoryUseCase_ts_1 = require("../../../application/useCases/createCategoryUseCase.ts");
const CategoryRepositoryImpl_ts_ts_1 = require("../../../infrastructure/database/repositories/category/CategoryRepositoryImpl.ts.ts");
...
const createCategoryController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const createdCategory = yield (0, createCategoryUseCase_ts_1.createCategoryUseCase)(CategoryRepositoryImpl_ts_ts_1.CategoryRepository)(newCategory);
        if (!createdCategory) {
