...
const readIntructorController_1 = require("../controller/readIntructorController");
...
router.get("/read", verifyToken_1.jwtMiddleware, (0, roleMiddleware_1.default)("admin"), readIntructorController_1.readIntructorController);
